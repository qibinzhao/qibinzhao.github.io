...
links:
  - type: pdf
    display: PDF
    url: https://proceedings.mlr.press/v202/li23ar/li23ar.pdf
  - type: code
    display: Code
    url: https://github.com/ChaoLiAtRIKEN/TnALE
bibtex: '@inproceedings{li2023alternating,
  title={Alternating local enumeration (tnale): Solving tensor network structure search with fewer evaluations},
